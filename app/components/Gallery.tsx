...
// 케이스 스터디 화면 모아보기 — 다크 브라우저 프레임 그리드 + 라이트박스.
// (WebGL 리버는 텍스처 화질 저하·세로 스크린샷 왜곡 문제로 폐기, 크리스프 img 그리드로 통일.)
        ...
        <div className="fixed inset-0 z-[100] bg-black/95" onClick={close}>
          ...
          <div className="flex h-full flex-col items-center justify-center gap-4 px-14 pb-6 pt-16">
            ...
            <img
              ...
              className="max-h-[78vh] max-w-full cursor-zoom-out rounded-lg object-contain shadow-2xl"
            />
